...
INSERT INTO "new_User" ("activeSkin", "balance", "bananaBoostUntil", "bananaCooldownUntil", "createdAt", "firstName", "flagged", "id", "lastBatchAt", "lastDailyClaim", "settings", "tapIndex", "tapSeed", "tgId", "totalTaps", "updatedAt", "upgradeLevel", "username") SELECT "activeSkin", "balance", "bananaBoostUntil", "bananaCooldownUntil", "createdAt", "firstName", "flagged", "id", "lastBatchAt", "lastDailyClaim", "settings", "tapIndex", "tapSeed", "tgId", "totalTaps", "updatedAt", "upgradeLevel", "username" FROM "User";
DROP TABLE "User";
