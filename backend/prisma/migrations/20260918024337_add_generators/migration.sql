...
CREATE TABLE "new_User" (
    ...
    "generatorLevel" INTEGER NOT NULL DEFAULT 0,
...
INSERT INTO "new_User" ("activeSkin", "balance", "bananaBoostUntil", "bananaCooldownUntil", "chips", "createdAt", "firstName", "flagged", "id", "lastBatchAt", "lastDailyClaim", "maxUpgradeLevel", "settings", "tapIndex", "tapSeed", "tgId", "totalTaps", "updatedAt", "upgradeLevel", "username") SELECT "activeSkin", "balance", "bananaBoostUntil", "bananaCooldownUntil", "chips", "createdAt", "firstName", "flagged", "id", "lastBatchAt", "lastDailyClaim", "maxUpgradeLevel", "settings", "tapIndex", "tapSeed", "tgId", "totalTaps", "updatedAt", "upgradeLevel", "username" FROM "User";
DROP TABLE "User";
