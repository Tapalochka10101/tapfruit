/*
  ...
  - You are about to drop the column `generatorLevel` on the `User` table. All the data in the column will be lost.
...
INSERT INTO "new_User" ("activeSkin", "balance", "bananaBoostUntil", "bananaCooldownUntil", "chips", "createdAt", "firstName", "flagged", "generators", "id", "lastBatchAt", "lastDailyClaim", "lastPassiveAt", "maxUpgradeLevel", "settings", "tapIndex", "tapSeed", "tgId", "totalTaps", "updatedAt", "upgradeLevel", "username") SELECT "activeSkin", "balance", "bananaBoostUntil", "bananaCooldownUntil", "chips", "createdAt", "firstName", "flagged", "generators", "id", "lastBatchAt", "lastDailyClaim", "lastPassiveAt", "maxUpgradeLevel", "settings", "tapIndex", "tapSeed", "tgId", "totalTaps", "updatedAt", "upgradeLevel", "username" FROM "User";
DROP TABLE "User";
